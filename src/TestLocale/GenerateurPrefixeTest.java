...
public class GenerateurPrefixeTest {
    ...
    public static void main(String[] args) {
        ...
        liste1.add(new Nom("2", "Albert"));
        liste1.add(new Nom("3", "Bruno"));

        // Création de la liste 2
        List<Nom> liste2 = new ArrayList<>();
        liste2.add(new Nom("4", "Alfred"));  // Match avec Alice, Albert
        liste2.add(new Nom("5", "Brigitte")); // Match avec Bruno
        liste2.add(new Nom("6", "Charlie"));  // Pas de match
